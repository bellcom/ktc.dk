...
require dirname(__FILE__) . '/transform_files.php';
...
// unset the field for the node
  if ($existing_node->field_os2web_base_field_media[LANGUAGE_NONE][0]['uri']==""){      
    ...
    ktc_import_field_fetch_file($existing_node, 'field_file', $node->field_file, ['field' => 'field_os2web_base_field_media'], $existing_node->language);
    node_save($existing_node);
  }  
  } else {
