...
<div class="row" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="col-md-4 col-sm-4 col-xs-12 col-md-push-4 col-sm-push-4  pane-right">
    <?php print $content['right']; ?>
  </div>
  <div class="col-md-4 col-sm-4 col-xs-12 col-md-pull-4 col-sm-pull-4 pane-center">
