<?php if ($teaser): ?>
    ...
    <article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>  ktc-teaser"<?php print $attributes; ?>>
        ...
        <div class="ktc-footer">
            ...
            <span data-toggle="tooltip" data-placement="bottom"title="Visninger" data-toggle="tooltip" data-placement="bottom" title="Visninger" class="ktc-footer-button ktc-footer-button-viewers"><?php print $signup_total; ?></span>
