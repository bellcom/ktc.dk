...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> ktc-list-display-large"<?php print $attributes; ?>>
  ...
  <div class="ktc-list-display-large-body">
    ...
    <?php if (isset($content['field_netvaerkstype'])): ?>
      <!-- Begin - group type -->
      <div class="ktc-list-display-large-subheadline"><?php print render($content['field_netvaerkstype']); ?></div>
      <!-- End - group type -->
    <?php endif; ?>
    ...
    <?php if (isset($content['field_regioner'])): ?>
      <!-- Begin - region -->
      <div class="ktc-list-display-large-subheadline"><?php print render($content['field_regioner']); ?></div>
      <!-- End - region -->
    <?php endif; ?>
