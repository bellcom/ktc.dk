    ...
    <div class="ktc-listevisning-content">
        ...
        <?php if (isset($network_groups)): ?>
            <?php foreach($network_groups AS $network_group): ?>
                <a href="<?php global $base_url; print $base_url . $node_url; ?>" class="ktc-listevisning-title"><?php print $network_group->title; ?></a>
            <?php endforeach ?>
        <?php endif ?>
        ...
        <?php if (isset($hearing_duedate)): ?>
            <p class="ktc-listevisning-date-simple"><?php print t('Svarfrist:'); ?> <?php print $hearing_duedate; ?></p>
        <?php endif ?>
